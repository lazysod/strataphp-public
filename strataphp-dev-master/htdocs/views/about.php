    ...
    <div class="container px-5 my-5">
        <div class="row gx-5">
            <div class="col-lg-8 mx-auto mb-5 mb-lg-0">
                ...
                <p class="lead"><?php echo isset($site_name) ? $site_name : ''; ?> is a minimal PHP framework designed to help you build web applications quickly and efficiently. It includes essential features like routing, controllers, and views, allowing you to focus on your application's logic without worrying about the underlying infrastructure.</p>
